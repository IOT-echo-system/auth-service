...
class AuthControllerTest {
    ...
    private val authController = AuthController(userService = userService, tokenService = tokenService)
...
//    @Test
//    fun `should save user password with user user id`() {
//        val userDetails = UserDetailsBuilder(userId = "userId", password = "password").build()
//
//        val userSignUpRequest = UserSignUpRequest(name = "name", email = "email", password = "password")
//        val response = authController.savePassword(userSignUpRequest)
//
//
